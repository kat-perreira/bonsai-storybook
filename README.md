...
<img src="https://static.thenounproject.com/png/1224071-200.png" alt="React Styleguidist" width="400">

# **Bonsai Storybook Highspot**

A deployed version of this POC can be found [here](https://bonsai-storybook.netlify.com)

## Getting Started

```
git clone git@github.com:kat-perreira/bonsai-storybook.git
npm install
npm run storybook
```
